...
Hoy entrega cinco bloques principales:
...
- **GitHub Sync** para issue types, sub-issues, dependencias, operaciones Projects V2, normalizacion de webhooks y eventos Synapse
