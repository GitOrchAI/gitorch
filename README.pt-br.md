...
Hoje ele entrega dois blocos principais:
...
- [ ] **F3: Graph RAG Pipeline** - Processamento de consultas semanticas
- [ ] **F4: Synapse + Feromonios** - Primitivas de coordenacao multi-agente
